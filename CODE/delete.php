...
if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    if($stmt->execute([$userId])) {
        header("location: surprise/Utilisateurs.php?message=L'utilisateur a été supprimé !");
        exit();
    } else {
        header("location: surprise/Utilisateurs.php?message=Oops! Une erreur s'est produite. Veuillez réessayer plus tard. !");
        exit();
